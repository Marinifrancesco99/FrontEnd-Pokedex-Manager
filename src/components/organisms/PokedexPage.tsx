...
const PokemonCard: React.FC<{ 
    ...
    const handleDeleteFromPokedex = async (e: React.MouseEvent) => {
        e.stopPropagation();
            ...
            <div class="text-center">
                ...
                <div id="messageContainer">
                    <p class="text-xl font-bold text-white mb-6">
                        Sei sicuro di voler eliminare <span class="text-emerald-400">${pokemon.english_name}</span> dalla Pokedex?
                    </p>
            ...
            if (messageContainer) {
                try {
                    ...
                    message = message
                        ...
                        .replace(/[{}"]/g, '')
                        .replace(/:\s*/g, ' ')
                        .replace(/["{]Pokemon eliminato dalla pokedex con successo[}"].*/i, 'Pokemon eliminato dalla pokedex con successo!')
            ...
            <div className="card-body items-center text-center p-4">
                ...
                <div className="card-actions justify-center mt-4">
                    <button 
                        ...
                        onClick={handleDeleteFromPokedex}
                    >
                        Elimina dalla Pokedex
                    </button>
                </div>
            </div>
        </div>
...
const PokedexPage: React.FC<{ onNavigate: (page: string) => void; onLogout: () => void }> = ({ onNavigate, onLogout }) => {
    ...
    const fetchPokemons = async () => {
        try {
            ...
            const response = await fetch('/api/v1/protected/pokedex', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`
                }
